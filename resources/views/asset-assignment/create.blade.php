@extends('layouts.app', ['activePage' => 'asset-assignment', 'titlePage' => __('Assign Asset')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('asset-assignment.store') }}" autocomplete="on" class="form-horizontal">
                        @csrf

                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('Assign Asset') }}</h4>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('employee') ? ' has-danger' : '' }}">
                                            <select class="selectpicker" data-style="btn btn-primary btn-round" id="input-employee"
                                                    title="Select Employee" data-live-search="true" name="department">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('condition') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('condition') ? ' is-invalid' : '' }}" name="condition" id="input-condition" type="text" placeholder="{{ __('Item Condition') }}" value="{{ old('condition') }}" required="true" aria-required="true"/>
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('assigned_date') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('assigned_date') ? ' is-invalid' : '' }}"
                                                   name="assigned_date" id="input-assigned_date" type="date" placeholder="{{ __('Employee Joining Date') }}" value="{{ old('assigned_date') }}" required="true" aria-required="true"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status" id="input-status" type="text" placeholder="{{ __('Item Condition') }}" value="{{ old('status') }}" required="true" aria-required="true"/>
                                            ...
                                            <div class="form-group{{ $errors->has('knox_status') ? ' has-danger' : '' }}">
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="checkbox" name="knox" value="">
                                                        Knox
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="card-footer ml-auto mr-auto">
                                        <button type="submit" class="btn btn-primary">{{ __('Assign Asset') }}</button>
                                    </div>
                                </div>
