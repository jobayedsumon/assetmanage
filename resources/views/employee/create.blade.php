@extends('layouts.app', ['activePage' => 'employee', 'titlePage' => __('Add Employee')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('employee.store') }}" autocomplete="on" class="form-horizontal">
                        @csrf
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Employee full name') }}" value="{{ old('name') }}" required="true" aria-required="true"/>
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('phone_number') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" name="phone_number" id="input-phone_number" type="text" placeholder="{{ __('Employee phone number') }}" value="{{ old('phone_number') }}" required="true" aria-required="true"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" id="input-email" type="text" placeholder="{{ __('Employee email') }}" value="{{ old('email') }}" required="true" aria-required="true"/>
                                                @if ($errors->has('email'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('nid') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('nid') ? ' is-invalid' : '' }}" name="nid" id="input-nid" type="text" placeholder="{{ __('Employee NID number') }}" value="{{ old('nid') }}" required="true" aria-required="true"/>
                                                @if ($errors->has('nid'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('address') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" name="address" id="input-address" type="text" placeholder="{{ __('Employee address') }}" value="{{ old('address') }}" required="true" aria-required="true"/>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('joining_date') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('joining_date') ? ' is-invalid' : '' }}" min="0"
                                                       name="joining_date" id="input-joining_date" type="date" placeholder="{{ __('Employee Joining Date') }}" value="{{ old('joining_date') }}" required="true" aria-required="true"/>
