@extends('layouts.app', ['activePage' => 'items', 'titlePage' => __('Create Item')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('items.store') }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('Item name with model') }}" value="{{ old('name') }}" required="true" aria-required="true"/>
                                            @if ($errors->has('name'))
                                                <span id="name-error" class="error text-danger" for="input-name">{{ $errors->first('name') }}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('identification_no') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('identification_no') ? ' is-invalid' : '' }}" name="identification_no" id="input-identification_no" type="text" placeholder="{{ __('Item identification number') }}" value="{{ old('identification_no') }}" required="true" aria-required="true"/>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('purchase_date') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('purchase_date') ? ' is-invalid' : '' }}" min="0"
                                                       name="purchase_date" id="input-purchase_date" type="date" placeholder="{{ __('Purchase Date') }}" value="{{ old('purchase_date') }}" required="true" aria-required="true"/>
